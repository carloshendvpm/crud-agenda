...
<body class="bg-light">
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark bg-gradient" id="topNavBar">
        <div class="container">
            ...
            <div>
                <b class="text-light">AGENDA</b>
            </div>
            <div>
              <b><h2><a href="logout.php">Sair</a></h2></b>
            </div>
        </div>
    </nav>
            ...
            <div class="col-md-3">
                <div class="cardt rounded-0 shadow">
                    <div class="card-header bg-gradient bg-primary text-light">
                        <h5 class="card-title">Agenda - Tarefa</h5>
                    </div>
                    <div class="card-body">
                        <div class="container-fluid">
                            <form action="save_schedule.php" method="post" id="schedule-form">
                                ...
                                <div class="form-group mb-2">
                                    <label for="title" class="control-label">Titulo da tarefa</label>
                                ...
                                <div class="form-group mb-2">
                                    <label for="start_datetime" class="control-label">Ínicio</label>
            ...
            <div class="modal-content rounded-0">
                ...
                <div class="modal-footer rounded-0">
                    <div class="text-end">
                        ...
                        <button type="button" class="btn btn-secondary btn-sm rounded-0" data-bs-dismiss="modal" aria-label="Close">Fechar</button>
                    </div>
                </div>
            </div>
        </div>
...
<?php 
$agendas = $conexao->query("SELECT * FROM `agenda`");
$sched_res = [];
foreach($agendas->fetch_all(MYSQLI_ASSOC) as $row){
